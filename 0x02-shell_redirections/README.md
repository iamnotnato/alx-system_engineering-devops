...
> 💾 **File :** [7-file](./7-file)
> 
> 📑 **Task :** A shell script that creates a file named exactly \*\\'"Best School"\'\\*$\?\*\*\*\*\*:) containing the text Best School ending by a new line.
> 
...
> 
> 📑 **Task :** A script that deletes all the regular files (not the directories) with a .js extension that are present in the current directory and all its subfolders.
> 
<br> 
...
> 
> 📑 **Task :** A command that finds all empty files and directories in the current directory and all sub-directories.
> 
> 📝 **Required :**
...
|-| (file Rona should be listed after file jay)                                         |
|-| One file name per line.                                                             | 
|-| The listing should end with a new line.                                             | 
|-| You are not allowed to use basename, grep, egrep, fgrep or rgrep.                   | 
